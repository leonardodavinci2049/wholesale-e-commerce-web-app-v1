...
const PRODUCT_ROUTES = [
  "/dashboard/product/products-on-sale",
  "/dashboard/product/products-new-releases",
  "/dashboard/product/products-best-selling",
];
const STORAGE_KEY = "promo:product-view-mode";
type ViewMode = "grid" | "list";

export function HeaderPromoViewToggle() {
  ...
  if (!PRODUCT_ROUTES.includes(pathname)) {
    return null;
  }
