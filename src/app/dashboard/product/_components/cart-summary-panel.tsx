...
import { ViewSaleButton } from "./view-sale-button";
...
export function CartSummaryPanel({
  ...
  return (
    <div className="flex max-h-[calc(100vh-2rem)] flex-col overflow-hidden rounded-2xl border border-border/50 bg-card/95 shadow-sm">
      ...
      <footer className="space-y-3 border-t border-border/40 bg-background/50 px-4 py-3">
        {orderId && (
          <div>
        ...
        <ViewSaleButton orderId={orderId} disabled={itemCount === 0} />
      </footer>
    </div>
  );
}
