export interface LogLoginFindAllDto {
...
/**
 * Valida o DTO para selecionar todos os logs de login
 */
export function validateLogLoginFindAllDto(data: unknown): LogLoginFindAllDto {
