...
const publicEnvsSchema = z.object({
  ...
  NEXT_PUBLIC_COMPANY_MAPS_URL_EMBED: z.string().url(),
  NEXT_PUBLIC_COMPANY_MAPS_URL_SHORT: z.string().url(),
...
export const publicEnvs = parseEnv(
  publicEnvsSchema,
  {
    ...
    NEXT_PUBLIC_COMPANY_MAPS_URL_EMBED:
      process.env.NEXT_PUBLIC_COMPANY_MAPS_URL_EMBED,
    NEXT_PUBLIC_COMPANY_MAPS_URL_SHORT:
      process.env.NEXT_PUBLIC_COMPANY_MAPS_URL_SHORT,
